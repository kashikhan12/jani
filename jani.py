#SOURCE LEAKED BY :MR-SULTAN
#REASON : BECAUSE KGF
#WAS INTERFERE BETWEEN
#AWAIS & LKING FIGHT 😎 
from os import path
import os,base64,zlib,pip,urllib
os.system('xdg-open fb://group/352478261991383?ref=share&mibextid=afzh1R/')
...
----------------------------------------------
 Author    : MR SULTAN
 Github    :  SULTAN KING 1
 Facebook  : MON X TR 
 Tool Name : SULTAN-PRO
 Type type : PAID
 Version   : 1.9.8
----------------------------------------------
 AKING Pro version 1.9.8
 For Haters: 🥰 WELCOM TO NEW FRIENDS 🤞
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                wx=('BteuLe3tXmDEfLecmwMuWm')
                                os.system(f'xdg-open https://chat.whatsapp.com/{wx}');menu()
                        elif xd in ['7','07']:
                                os.system('xdg-open https://www.youtube.com/@TERMUXMASTER.p');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.facebook.com/bhalal.dev.733?mibextid=ZbWKwL');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        tks = ("Hi SULTAN Sir, I Need To Buy Your Paid Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python jani.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
